/*
az deployment group create --resource-group "shm-VM-Module-Test" --name "Deploy-Of-vmNIC01-NetworkInterfaces" --parameters 02a-New-NetworkInterfaces.bicepparam
...
param nicName = 'vmNIC01' //'vmNIC' The name of the Nic
param createPublicIP = true //true / false
param publicIPName = 'shmVM-PublicNet01' //'shmVMSQL-PublicNet01' The name of the public IP (This has no effect if the NIC is private)
